...
<section id="movie-content" class="">
    <div class="main-movie relative w-full mb-20">
        ...
        <script>
            ...
            function showAlert(message, type) {
                ...
                if (type === 'success') {
                    alertElement.removeClass('error').addClass('success');
                } else if (type === 'error') {
                    alertElement.removeClass('success').addClass('error');
                }

                alertElement.fadeIn().delay(2000).fadeOut();
            }
        </script>
    </div>
    <div class="movie-container flex flex-wrap lg:px-20 sm:px-12 px-8 gap-x-10">
        <div class="movie-container-left lg:w-[70%] w-full">
            @if ($movie->category_id == 6 && $movie->status !== 'trailer') 
                <div class="most-new-episode w-full">
                    <div class="heading">
                        <a href="">
    ...
    {{-- -----------------Slide---------------------------------- --}}
    <div class="card-slider relative lg:px-20 sm:px-12 px-8">
